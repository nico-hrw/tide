...
Write-Host "--- Starting Sharing Verification ---"
...
try {
    ...
    # MVP Note: ListFiles (MyFiles) logic typically only shows Shared+Own. 
    # Public files might strictly be in `ListPublicFiles`.
    # Let's check `ListPublicFiles` endpoint.
