    ...
    const renderAccount = () => (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
            <div>
                ...
                <div className="flex items-center gap-6 p-6 rounded-2xl bg-gray-50 dark:bg-black/20 border border-gray-100 dark:border-white/5">
                    ...
                    <div className="flex-1 space-y-1">
                        ...
                        <input
                            type="text"
                            defaultValue={userProfile?.username || 'User'}
                            className="w-full bg-transparent text-xl font-black text-gray-900 dark:text-white outline-none border-b border-transparent focus:border-blue-500 transition-colors"
                        />
                        <div className="pt-2">
                            ...
                            <input
                                ...
                                className="w-full bg-transparent text-sm text-gray-600 dark:text-gray-400 outline-none border-b border-transparent focus:border-blue-500 transition-colors"
                            />
                        </div>
                    </div>
                </div>
