        ...
        <div className="flex flex-col h-full select-none">
                    ...
                    <div className="flex min-w-max relative">
                        ...
                        {days.map(day => {
                            ...
                            return (
                                ...
                                >
                                    {/* Day Header */}
                                    <div className="h-[50px] border-b border-[var(--border-grid)] sticky top-0 z-[70] flex items-center justify-center gap-1.5 bg-[var(--background)]">
            ...
            {activePopover && (() => {
                ...
                return (
                    <div
                        ref={popoverRef}
                        className="fixed z-[100] w-[340px] bg-[var(--background)] rounded-2xl shadow-2xl border border-[var(--border-grid)] p-5 flex flex-col gap-3"
                    ...
                    >
                            ...
                            <input
                                ...
                                onBlur={(e) => {
                                    if (e.target.value !== event.title) {
                                        onEventSave && onEventSave(event.id, { title: e.target.value });
                                    }
                                }}
                                onKeyDown={(e) => {
                                    if (e.key === 'Enter') e.currentTarget.blur();
                                }}
                                className="text-lg font-semibold text-gray-900 dark:text-slate-100 leading-tight pr-4 bg-transparent border-none focus:ring-0 p-0 w-full outline-none"
                                placeholder="Event Title"
                            />
                            <button
                                onClick={() => setActivePopover(null)}
                                className="p-1 rounded-full text-gray-400 dark:text-slate-500 hover:text-gray-700 dark:hover:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors shrink-0"
                            >
                        ...
                        {/* Notes */}
                        <div className="flex gap-2 text-gray-500 dark:text-slate-400 mt-2 bg-gray-50 dark:bg-slate-800/50 p-3 rounded-xl border border-[var(--border-grid)]">
                            ...
                            <textarea
                                ...
                                onBlur={(e) => {
                                    if (e.target.value !== (event.description || '')) {
                                        onEventSave && onEventSave(event.id, { description: e.target.value });
                                    }
                                }}
